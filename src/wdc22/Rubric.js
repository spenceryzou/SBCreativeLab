...
import rubricMobile from './imgs/rubric-mobile.svg'
import rubricTitleMobile from './imgs/rubric-title-mobile.svg'
...
export default function Rubric() {
    return (
        <div className='rubric'>
            ...
            <div className='rubric-mobile-container'>
                <img className='rubric-title-mobile' src={rubricTitleMobile}></img>
                <img className='rubric-mobile' src={rubricMobile}></img>
            </div>
